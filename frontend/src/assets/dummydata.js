...
export const socialIcons = [
    { icon: FaFacebook, link: 'https://www.linkedin.com/in/nitin-mawatwal/', color: '#3b5998', label: 'Facebook' },
    { icon: FaInstagram, link: 'https://www.linkedin.com/in/nitin-mawatwal/ ', color: '#E1306C', label: 'Instagram' },
    { icon: FaXTwitter, link: 'https://www.linkedin.com/in/nitin-mawatwal/', color: '#000', label: 'X' },
    { icon: FaYoutube, link: 'https://www.linkedin.com/in/nitin-mawatwal/', color: '#FF0000', label: 'Youtube' },
];
